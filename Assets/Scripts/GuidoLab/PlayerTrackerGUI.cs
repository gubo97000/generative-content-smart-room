...
[CustomEditor(typeof(KinectSkeletonManager)), CanEditMultipleObjects]
public class PlayerTrackerGUI : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (((KinectSkeletonManager)target).activateHandCloseEvents)
        {
        ...
        EditorGUILayout.EndHorizontal();
        if (((KinectSkeletonManager)target).activateGestureEvents)
        {
